...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteTrajectoryResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteTrajectoryResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hra_msgs-msg:<ExecuteTrajectoryResult> is deprecated: use hra_msgs-msg:ExecuteTrajectoryResult instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ExecuteTrajectoryResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hra_msgs-msg:success-val is deprecated.  Use hra_msgs-msg:success instead.")
  (success m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ExecuteTrajectoryResult>)))
  ...
  "hra_msgs/ExecuteTrajectoryResult")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ExecuteTrajectoryResult)))
  "Returns string type for a message object of type 'ExecuteTrajectoryResult"
  "hra_msgs/ExecuteTrajectoryResult")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ExecuteTrajectoryResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Result: 任务结果~%bool success                  # 任务是否成功完成~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ExecuteTrajectoryResult)))
  "Returns full string definition for message of type 'ExecuteTrajectoryResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Result: 任务结果~%bool success                  # 任务是否成功完成~%~%~%"))
